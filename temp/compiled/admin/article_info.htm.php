...
<div class="tab-div">
  <div id="tabbar-div">
    <p>
      ...
      <span class="tab-back" id="detail2-tab"><?php echo $this->_var['lang']['tab_content_en']; ?></span>
  ...
  <div id="tabbody-div">
    ...
    <table width="90%" id="general-table">
      ...
      <tr>
        ...
        <td><input type="text" name="title_en" size ="40" maxlength="60" value="<?php echo htmlspecialchars($this->_var['article']['title_en']); ?>" /><?php echo $this->_var['lang']['require_field']; ?></td>
      </tr>        
    ...
    <table width="90%" id="detail2-table" style="display:none">
     <tr><td><?php echo $this->_var['content_en']; ?></td></tr>
    </table>
