...
<table cellspacing="1" cellpadding="3" width="100%">
  ...
  <tr>
    ...
    <td><input type="text" name="cat_name_en" maxlength="60" size = "30" value="<?php echo htmlspecialchars($this->_var['cat']['cat_name_en']); ?>" /><?php echo $this->_var['lang']['require_field']; ?></td>
  </tr>
  <tr>
