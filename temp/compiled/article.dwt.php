...
<div class="content clearfix w1140">
    ...
    <div class="cont-l">
        ...
        <ul>
            <?php $_from = $this->_var['article_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'article_0_52655100_1446040610');$this->_foreach['article_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['article_list']['total'] > 0):
    foreach ($_from AS $this->_var['article_0_52655100_1446040610']):
        $this->_foreach['article_list']['iteration']++;
?> 
            <li <?php if ($this->_var['id'] == $this->_var['article_0_52655100_1446040610']['id']): ?> class="on" <?php endif; ?>><a href="<?php echo $this->_var['article_0_52655100_1446040610']['url']; ?>"><?php echo $this->_var['article_0_52655100_1446040610']['title']; ?></a></li>
