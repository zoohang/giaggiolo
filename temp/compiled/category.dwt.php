...
?>
                ...
                <li>
                    <div class="lishop">
                        <div class="shopimg">
                            <a href="<?php echo $this->_var['goods']['url']; ?>" class="no-bcolor"><img src="<?php echo $this->_var['goods']['goods_img']; ?>" width="243px" height="324px"></a>
                        ...
                        <p><a href="<?php echo $this->_var['goods']['url']; ?>"><?php echo $this->_var['goods']['goods_name']; ?></a></p>
