...
?>
  ...
  <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    ...
    <p><img src="themes/my/images/shop_tit.jpg"></p>
    <div class="noshop <?php if ($this->_var['goods_list']): ?> hide <?php endif; ?>">
        <img src="themes/my/images/noshop.jpg">
...
?>
            <li>
                <p class="del-p">
                    <input type="button" class="del-btn" onclick="javascript:if (confirm('<?php echo $this->_var['lang']['drop_goods_confirm']; ?>')) location.href='flow.php?step=drop_goods&amp;id=<?php echo $this->_var['goods']['rec_id']; ?>'; ">
                </p>
                <div class="cartimg">
                    <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" class="f6"><img width="100px" height="136px" src="<?php echo $this->_var['goods']['goods_thumb']; ?>"></a>
                </div>
                <div class="cart-nr">
                    <p class="cnr-tit"><a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><?php echo $this->_var['goods']['goods_name']; ?></a></p>
                    <p class="cnr-num">Model No:3578</p>
                    <div class="cart-jg">
                        <span class="price-span fl"><strong><?php echo $this->_var['goods']['goods_price']; ?></strong></span>
                        <div class="price-num fl">
                           <span class="price-span1">Qty::</span>
                            <div class="sl-num">
                                <a href="javascript:;" class="add-btn J_plus" onclick="goods_add(<?php echo $this->_var['goods']['goods_id']; ?>)"></a>
                                <input type="text" name="goods_number[<?php echo $this->_var['goods']['rec_id']; ?>]" id="goods_number_<?php echo $this->_var['goods']['goods_id']; ?>" value="<?php echo $this->_var['goods']['goods_number']; ?>" class="num-txt buy_num" onchange="document.getElementById('update_btn').click()"/>
                                <a href="javascript:;" class="reduce-btn J_minus" onclick="goods_cut(<?php echo $this->_var['goods']['goods_id']; ?>)"></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <input name="submit" type="submit" style="display: none;" id="update_btn" class="bnt_blue_1" value="<?php echo $this->_var['lang']['update_cart']; ?>" />
        <input type="hidden" name="step" value="update_cart" />
    </form>
    <a href="flow.php?step=checkout"><div class="ordernow">Place Order</div></a>
    </div>
</div>
